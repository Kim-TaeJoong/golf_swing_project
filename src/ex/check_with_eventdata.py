...
#mcilroy_events = {'Address': 19, 'Takeaway' : 52 ,'Mid-Backswing' : 204, 'Top': 295,'Impact': 384,'Follow-through' : 415,'Finish' : 522}
#mcilroy_events_dtw = {'Address': 38, 'Takeaway' : 47 ,'Mid-Backswing' : 209, 'Top': 279,'Impact': 363,'Follow-through' : 412,'Finish' : 484}
morikawa_events = {'Address': 55, 'Takeaway' : 91 ,'Mid-Backswing' : 325, 'Top': 429,'Downswing' : 439,'Impact': 550,'Follow-through' : 583,'Finish' : 584}
my_targets = ['r_elbow', 'l_elbow']
#plot_selected_features('data/processed/mcilroy_angle_enhanced.csv',target_features=my_targets, events=mcilroy_events_dtw)
plot_selected_features('data/processed/tigerwoods_angle_enhanced.csv',target_features=my_targets, events=events)
play_video_with_events('data/processed/morikawa_final_enhanced.mp4', morikawa_events)
