...
if __name__ == "__main__":
    ...
    PRO_PATH = os.path.join(ROOT, 'data', 'processed', 'tigerwoods_swing_landmarks_enhanced.csv')
    USER_PATH = os.path.join(ROOT, 'data', 'processed', 'mcilroy_swing_landmarks_enhanced.csv')
