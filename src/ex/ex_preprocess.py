...
if __name__ == "__main__":
    ...
    #Rory McIlroy
    #video_url = "https://www.youtube.com/watch?v=P3YksJdejog"
    #Collin Morikawa
    video_url = "https://www.youtube.com/watch?v=02imCuJAZCw"

    save_path = "data/raw/morikawa_raw.mp4" 
...
if __name__ == "__main__":
    input_file = "data/raw/morikawa_raw.mp4"
    output_file = "data/processed/morikawa_final_enhanced.mp4"
